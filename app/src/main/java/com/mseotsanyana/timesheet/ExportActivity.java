...
import com.mseotsanyana.timesheet.TimesheetDatabase;
...
public class ExportActivity extends Activity {
    ...
    private void sendEmail(Context ctx)
    {
        ...
        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{m_default_email});
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, subject);
        emailIntent.putExtra(Intent.EXTRA_TEXT, getSummaryData());
